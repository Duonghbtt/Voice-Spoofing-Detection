...
python src/features/extract_mfcc.py --split train dev eval

# Trích xuất LFCC (40 coefficients, linear filterbank)
python src/features/extract_lfcc.py --split train dev eval

# Trích xuất Log-mel Spectrogram (64 mel bins, 128 time frames)
python src/features/extract_spec.py --split train dev eval
```
...
python src/train.py --feature mfcc --model cnn --epochs 50 --batch_size 64

# ResNet với LFCC
python src/train.py --feature lfcc --model resnet --epochs 50 --batch_size 32

# LCNN với Spectrogram
python src/train.py --feature spectrogram --model lcnn --epochs 50 --batch_size 32
...
python src/evaluate.py --checkpoint outputs/checkpoints/best_model.pth --dataset 2019

# Generalization test trên ASVspoof 2021
python src/evaluate.py --checkpoint outputs/checkpoints/best_model.pth --dataset 2021

# Error analysis theo từng loại attack
python src/evaluate.py --checkpoint outputs/checkpoints/best_model.pth --per_attack
```
...
python src/predict.py --audio path/to/your/audio.wav --checkpoint outputs/checkpoints/best_model.pth
```
